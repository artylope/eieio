    ...
    <div className="p-8 w-full">
      <div className="flex flex-col gap-y-2 max-w-xl mx-auto">
        <div className="w-full grow flex flex-col-reverse lg:flex-row justify-end gap-2 ">
          ...
          <button
            className="h-12 lg:w-fit flex bg-zinc-900 text-zinc-50 shadow-sm justify-start items-center cursor-pointer rounded-md border gap-x-0.5 px-4 hover:text-white hover:bg-zinc-800"
