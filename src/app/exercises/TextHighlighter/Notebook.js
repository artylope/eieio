          ...
          {isBottomSheetOpen && (
            <Dialog.Portal forceMount>
              ...
              <motion.div
                ...
                <Dialog.Content className="bg-white rounded-t-lg md:hidden flex flex-col max-h-[75vh] overflow-y-hidden">
                  ...
                  <div className="flex justify-end items-center w-full pb-8 px-5 ">
                    {savedTags.length === 0 ? (
                      ''
                    ) : (
                      <button
